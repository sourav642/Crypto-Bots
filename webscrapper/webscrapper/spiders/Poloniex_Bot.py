...
class PoloniexBotSpider(scrapy.Spider):
    name = 'Poloniex_Bot'
    allowed_domains = ['poloniex.com/exchange#btc_eth']
    start_urls = ['https://poloniex.com/exchange#btc_eth/']
