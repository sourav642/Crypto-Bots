...
class KrakenBotSpider(scrapy.Spider):
    name = 'Kraken_Bot'
    allowed_domains = ['www.kraken.com']
    start_urls = ['https://www.kraken.com/charts/']
    ...
    def __init__(self):
        ...
        options.add_argument("--user-agent=Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36");
