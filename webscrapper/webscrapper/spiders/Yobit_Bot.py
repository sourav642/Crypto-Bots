...
class YobitBotSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        result['Last Current price']=self.driver.find_element_by_xpath('//*[@id="label_last"]').text
        
        result['24 Hr Price Change']="NA"
        
        result['24 Hr High Price']=self.driver.find_element_by_xpath('//*[@id="label_high24"]').text
        
        result['24 Hr Low Price']= self.driver.find_element_by_xpath('//*[@id="label_vol24"]').text
        
        result['24 Hr Volume']= self.driver.find_element_by_xpath('//*[@id="label_vol24"]').text.split()[0]
        
        result['Coins']= "Bitcoin"
        
        result['Base Currency']=self.driver.find_element_by_xpath('//*[@id="data-pjax-container"]/div[1]/ul/li[1]').text.split('/')[1]
